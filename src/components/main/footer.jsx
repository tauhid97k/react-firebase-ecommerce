        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-green-600 text-lg font-semibold hover:text-green-400 border border-green-600 hover:border-green-400 transition-colors duration-200"
            >
        ...
        <div className="mt-12 border-t border-gray-100 pt-12">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <p className="mt-8 text-xs text-gray-500 sm:mt-0">
              &copy; 2022. KhujeNin. All rights reserved.
            </p>
          </div>
        </div>
      </div>
